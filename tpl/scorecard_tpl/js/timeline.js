            ...
            getHtml('goal', goalId, lang, '')
                    .done(function (data) {
                        if (!data) {
                            ...
                            $('#' + goalId).find('a').after("<a href='#' class='goal-details-open-button' data-toggle='modal' data-target='#goal-details'><i class='fa fa-search text-white right m-r-md m-t-xxs'></i></a><a href='#' class='goal-delete-button'><i class='fa fa-trash text-white right m-t-xxs'></i></a>");
