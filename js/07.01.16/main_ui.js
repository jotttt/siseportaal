...
(function ($) {
    ...
    **********************************************************/
		...
		$('.collapse-link').click( function() {
			var widgetWrapper = $(this).closest('div.widget-wrapper');
			var button = $(this).find('i');
			var content = widgetWrapper.find('div.ibox-content, div.ibox-content-full');
		...
		$('.close-link').click( function() {
			var content = $(this).closest('div.widget-wrapper');
			content.remove();
		});
