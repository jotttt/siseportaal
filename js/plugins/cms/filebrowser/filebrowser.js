...
function init() {
    ...
    // media list onClick
    $('.innernametext').on('click', function () {
        var the_link = $(this).parents('.row-links').attr("data-link");
        var name = $(this).parents('.row-links').attr("data-name");
    ...
    $('.crumb, .crumblink').on('click', function (e) {
        e.preventDefault();
